    ...
    <div className="w-60 bg-white border-r border-slate-100 min-h-screen p-5 flex flex-col justify-between shadow-sm font-sans">
      <div>
        ...
        <ul className="space-y-1">
          ...
          <li>
            <Link to="/admin/customers" className={`flex items-center gap-3 p-2.5 rounded-lg text-xs font-bold transition-all ${isActive('/admin/customers') ? 'bg-slate-900 text-white shadow-sm' : 'text-slate-500 hover:bg-slate-50'}`}>
                Customer Profiles
            </Link>
          </li>
        </ul>
      ...
      <div>
        {/* Exit page ko hatakar direct main user store ka redirect laga diya */}
